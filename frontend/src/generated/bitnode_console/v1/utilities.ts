 ...
 *
 * @generated from protobuf message bitnode_console.v1.PingRequest
 */
 ...
 *
 * @generated from protobuf message bitnode_console.v1.PingResponse
 */
...
class PingRequest$Type extends MessageType<PingRequest> {
    constructor() {
        super("bitnode_console.v1.PingRequest", []);
    }
...
/**
 * @generated MessageType for protobuf message bitnode_console.v1.PingRequest
 */
export const PingRequest = new PingRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class PingResponse$Type extends MessageType<PingResponse> {
    constructor() {
        super("bitnode_console.v1.PingResponse", [
...
/**
 * @generated MessageType for protobuf message bitnode_console.v1.PingResponse
 */
export const PingResponse = new PingResponse$Type();
/**
 * @generated ServiceType for protobuf service bitnode_console.v1.UtilitiesService
 */
export const UtilitiesService = new ServiceType("bitnode_console.v1.UtilitiesService", [
