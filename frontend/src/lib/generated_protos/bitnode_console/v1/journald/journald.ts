 ...
 *
 * @generated from protobuf message bitnode_console.v1.journald.v1.GetLogsRequest
 */
export interface GetLogsRequest {
    /**
     * Number of most-recent lines to return. Defaults to 100 when zero.
     *
     * @generated from protobuf field: uint32 lines = 1
     */
    lines: number;
}
/**
 ...
 *
 * @generated from protobuf message bitnode_console.v1.journald.v1.GetLogsResponse
 */
export interface GetLogsResponse {
    /**
     * Log entries in chronological order (oldest first).
     *
     * @generated from protobuf field: repeated bitnode_console.v1.journald.v1.LogEntry entries = 1
     */
    entries: LogEntry[];
}
/**
 ...
 *
 * @generated from protobuf message bitnode_console.v1.journald.v1.StreamLogsRequest
 */
 ...
 *
 * @generated from protobuf message bitnode_console.v1.journald.v1.LogEntry
 */
...
class GetLogsRequest$Type extends MessageType<GetLogsRequest> {
    constructor() {
        super("bitnode_console.v1.journald.v1.GetLogsRequest", [
            { no: 1, name: "lines", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: GetLogsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 lines = 1; */
        if (message.lines !== 0)
            writer.tag(1, WireType.Varint).uint32(message.lines);
...
/**
 * @generated MessageType for protobuf message bitnode_console.v1.journald.v1.GetLogsRequest
 */
export const GetLogsRequest = new GetLogsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetLogsResponse$Type extends MessageType<GetLogsResponse> {
    constructor() {
        super("bitnode_console.v1.journald.v1.GetLogsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetLogsResponse): GetLogsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated bitnode_console.v1.journald.v1.LogEntry entries */ 1:
    ...
    internalBinaryWrite(message: GetLogsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated bitnode_console.v1.journald.v1.LogEntry entries = 1; */
...
/**
 * @generated MessageType for protobuf message bitnode_console.v1.journald.v1.GetLogsResponse
 */
export const GetLogsResponse = new GetLogsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class StreamLogsRequest$Type extends MessageType<StreamLogsRequest> {
    constructor() {
        super("bitnode_console.v1.journald.v1.StreamLogsRequest", [
...
/**
 * @generated MessageType for protobuf message bitnode_console.v1.journald.v1.StreamLogsRequest
 */
export const StreamLogsRequest = new StreamLogsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class LogEntry$Type extends MessageType<LogEntry> {
    constructor() {
        super("bitnode_console.v1.journald.v1.LogEntry", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for bitnode_console.v1.journald.v1.LogEntry.extra_fields");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message bitnode_console.v1.journald.v1.LogEntry
 */
export const LogEntry = new LogEntry$Type();
/**
 * @generated ServiceType for protobuf service bitnode_console.v1.journald.v1.JournaldService
 */
export const JournaldService = new ServiceType("bitnode_console.v1.journald.v1.JournaldService", [
