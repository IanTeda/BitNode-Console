        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitnode_console.journald.v1.JournaldService/GetLogs",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitnode_console.journald.v1.JournaldService",
                        "GetLogs",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitnode_console.journald.v1.JournaldService/StreamLogs",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod journald_service_server {
    ...
    pub const SERVICE_NAME: &str = "bitnode_console.journald.v1.JournaldService";
