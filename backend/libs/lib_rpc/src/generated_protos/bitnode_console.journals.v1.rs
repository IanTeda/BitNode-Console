...
pub mod journals_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::GetJournalsResponse>, tonic::Status>
        {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/bitnode_console.journals.v1.JournalsService/GetJournals" => {
                    ...
                    impl<T: JournalsService> tonic::server::UnaryService<super::GetJournalsRequest>
                ...
                "/bitnode_console.journals.v1.JournalsService/FollowJournals" => {
                        ...
                        for FollowJournalsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as JournalsService>::follow_journals(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
